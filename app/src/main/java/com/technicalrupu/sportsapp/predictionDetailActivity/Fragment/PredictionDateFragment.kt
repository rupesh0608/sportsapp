...
import com.technicalrupu.sportsapp.predictionDetailActivity.Adapter.PredictionDateFragmentAdapter

class PredictionDateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_prediction_date, container, false)
        ...
        val adapter = PredictionDateFragmentAdapter(view.context, childFragmentManager,
            tabLayout.tabCount)
